...
class BD
{
    ...
    /**
     * @param $campos array asociativo con los nombres de los campos y sus valores a insertar
     * ['id'=>5, 'nombre'=>'Pedro', 'pass'=>'pass de pedro']
     * @param $tabla nombre de la tabla a insertar
     */
    public function insertar($campos, $tabla)
    {

        $sentencia_insert=$this->crea_sentencia_parametrizada ($campos, $tabla);
        $stmt=$this->con->stmt_init ();

        $stmt->prepare ($sentencia_insert);
...
//        var_dump ($parametros);
     ...
     */
    private function crea_sentencia_parametrizada($campos, $tabla)
    {
