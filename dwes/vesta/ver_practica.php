 ...
 * try {
 * $dir = Fichero::searchDirectorioWithTypeFiles("practicas/$practica/$alumno", "php_");
...
//    $ficheros = Fichero::getContenidoDir("./practicas/$practica/$alumno");
    ...
    foreach ($listado_ficheros as $fichero) {
         ...
         * Quiero solo tener los ficheros php_ y html
         */
        if ((strpos($fichero, "php_") === False) and (strpos($fichero, "php_") === False))
            continue;
