...
session_start();
//He de venir de show.php_. Pendiente asegurar esto ....
...
if (isset($_POST['submit'])) {
    switch ($_POST['submit']) {
        ...
        case 'Ver ficheros' :
            ...
            header("Location:ver_practica.php_?directorioAlumno=$dir_alumno");
            exit;
        case 'Corrección':
            $dir_alumno = $_POST['directorioAlumno'];
            header("Location:correccion.php_?directorioAlumno=$dir_alumno&pos_alumno=$pos_alumno");
            exit;
        case "Ver siguiente":
            $pos_alumno++;
            break;
...
<fieldset>
    ...
    echo "<form action=show_individual.php_ method='POST' target='_blank'>";
