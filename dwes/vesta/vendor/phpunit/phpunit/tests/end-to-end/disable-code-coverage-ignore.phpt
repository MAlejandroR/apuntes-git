...
$_SERVER['argv'][3] = '--coverage-text=php_://stdout';
$_SERVER['argv'][4] = '--disable-coverage-ignore';
$_SERVER['argv'][5] = __DIR__ . '/../_files/IgnoreCodeCoverageClassTest.php_';
$_SERVER['argv'][6] = '--whitelist';
$_SERVER['argv'][7] = __DIR__ . '/../_files/IgnoreCodeCoverageClass.php_';
