...
EOF;
    ...
    public function testShouldRunFileSectionAsTest()
    {
        ...
        $fileSection = '<?php_ echo "Hello PHPUnit!"; ?>' . PHP_EOL;
...
--FILE--
<?php_ echo __DIR__ . __FILE__; ?>
--EXPECT--
Something
EOF
        ));

        $renderedCode = "<?php_ echo '" . $this->dirname . "' . '" . $this->filename . "'; ?>" . PHP_EOL;
    ...
    public function testRenderSkipifSection()
    {
        ...
        $phptContent .= "<?php_ echo 'skip: ' . __FILE__; ?>" . PHP_EOL;

        $this->setPhpContent($phptContent);

        $renderedCode = "<?php_ echo 'skip: ' . '" . $this->filename . "'; ?>" . PHP_EOL;
    ...
    {
        $skipifSection = '<?php_ /** Nothing **/ ?>' . PHP_EOL;
    ...
    {
        $skipifSection = '<?php_ echo "skip: Reason"; ?>' . PHP_EOL;
    ...
    {
        $cleanSection = '<?php_ unlink("/tmp/something"); ?>' . PHP_EOL;
