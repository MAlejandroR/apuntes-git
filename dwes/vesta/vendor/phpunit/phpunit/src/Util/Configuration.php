 ...
 *          bootstrap="/path/to/bootstrap.php_"
 *          cacheTokens="false"
 *          columns="80"
 *          colors="false"
 *          stderr="false"
 ...
 *       <directory suffix="Test.php_" phpVersion="5.3.0" phpVersionOperator=">=">/path/to/files</directory>
 *       <file phpVersion="5.3.0" phpVersionOperator=">=">/path/to/MyTest.php_</file>
 ...
 *       <directory suffix=".php_">/path/to/files</directory>
 ...
 *
 *   <listeners>
 *     <listener class="MyListener" file="/optional/path/to/MyListener.php_">
 *       <arguments>
 *         <array>
 *           <element key="0">
...
class Configuration
{
    ...
    public function getPHPConfiguration()
    {
        ...
        foreach ($this->xpath->query('php_/includePath') as $includePath) {
        ...
        foreach ($this->xpath->query('php_/ini') as $ini) {
        ...
        foreach ($this->xpath->query('php_/const') as $const) {
        ...
        foreach (['var', 'env', 'post', 'get', 'cookie', 'server', 'files', 'request'] as $array) {
            foreach ($this->xpath->query('php_/' . $array) as $var) {
