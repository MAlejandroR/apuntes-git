...
class TestRunner extends BaseTestRunner
{
    ...
    public function doRun(Test $suite, array $arguments = [], $exit = true)
    {
        ...
        if ($this->printer === null) {
            if (isset($arguments['printer']) &&
                ...
                $this->printer = new $printerClass(
                    (isset($arguments['stderr']) && $arguments['stderr'] === true) ? 'php_://stderr' : null,
                    $arguments['verbose'],
                    $arguments['colors'],
                    $arguments['debug'],
                    $arguments['columns'],
        ...
        if (isset($codeCoverage)) {
            ...
            if (isset($arguments['coverageText'])) {
                if ($arguments['coverageText'] == 'php_://stdout') {
    ...
    protected function handleConfiguration(array &$arguments)
    {
        ...
        if (isset($arguments['configuration'])) {
            ...
            if (isset($loggingConfiguration['coverage-php_']) && !isset($arguments['coveragePHP'])) {
                $arguments['coveragePHP'] = $loggingConfiguration['coverage-php_'];
            }
