...
class Command
{
    ...
    protected function handleArguments(array $argv)
    {
        ...
        foreach ($this->options[0] as $option) {
            switch ($option[0]) {
                ...
                case '--generate-configuration':
                    ...
                    print 'Bootstrap script (relative to path shown above; default: vendor/autoload.php_): ';
                    ...
                    if ($bootstrapScript === '') {
                        $bootstrapScript = 'vendor/autoload.php_';
                    }
        ...
        if (!isset($this->arguments['testSuffixes'])) {
            $this->arguments['testSuffixes'] = ['Test.php_', '.phpt'];
        }
    ...
    protected function handlePrinter($printerClass, $printerFile = '')
    {
        ...
        $outputStream = isset($this->arguments['stderr']) ? 'php_://stderr' : null;
    ...
    protected function showHelp()
    {
        ...
        print <<<EOT
Usage: phpunit [options] UnitTest [UnitTest.php_]
...
Code Coverage Options:
  ...
  --coverage-php_ <file>       Export PHP_CodeCoverage object to file.
...
Test Selection Options:
  ...
  --test-suffix ...           Only search for test in files with specified
                              suffix(es). Default: Test.php_,.phpt
...
Configuration Options:
  ...
  -d key[=value]              Sets a php_.ini value.
