...
class BuilderTest extends TestCase
{
    ...
    public function testBuildDirectoryStructure()
    {
        ...
        $this->assertEquals(
            ...
            $method->invoke(
                $this->factory,
                ['src/Money.php_' => [], 'src/MoneyBag.php_' => []]
            )
        );
    }
    ...
    public function reducePathsProvider()
    {
        return [
            [
                ...
                '/home/sb/Money',
                [
                    '/home/sb/Money/Money.php_'    => [],
                    '/home/sb/Money/MoneyBag.php_' => []
                ]
            ],
            [
                [
            ...
            [
                ...
                [
                    '/home/sb/Money/Money.php_'                 => [],
                    '/home/sb/Money/MoneyBag.php_'              => [],
                    'phar:///home/sb/Money/Cash.phar/Cash.php_' => [],
                ],
            ],
        ];
    }
