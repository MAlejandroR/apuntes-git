...
class PHP_Token_ClassTest extends TestCase
{
    ...
    {
        $ts = new PHP_Token_Stream(TEST_FILES_PATH . 'source2.php_');
    ...
    {
        $ts = new PHP_Token_Stream(TEST_FILES_PATH . 'issue19.php_');
    ...
    {
        $ts = new PHP_Token_Stream(TEST_FILES_PATH . 'issue30.php_');
        $this->assertCount(1, $ts->getClasses());
    }

    public function testAnonymousClassesAreHandledCorrectly()
    {
        $ts = new PHP_Token_Stream(TEST_FILES_PATH . 'class_with_method_that_declares_anonymous_class.php_');
    ...
    {
        $ts = new PHP_Token_Stream(TEST_FILES_PATH . 'class_with_method_that_declares_anonymous_class2.php_');
    ...
    {
        $ts = new PHP_Token_Stream(TEST_FILES_PATH . 'classUsesNamespacedFunction.php_');
    ...
    {
        $ts = new PHP_Token_Stream(TEST_FILES_PATH . 'class_with_multiple_anonymous_classes_and_functions.php_');
    ...
    {
        $ts = new PHP_Token_Stream(TEST_FILES_PATH . 'class_with_method_named_empty.php_');
    ...
    {
        $ts = new PHP_Token_Stream(TEST_FILES_PATH . 'php_-code-coverage-issue-424.php_');
