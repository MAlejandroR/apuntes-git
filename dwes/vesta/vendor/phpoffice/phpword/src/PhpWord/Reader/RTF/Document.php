...
class Document
{
    ...
    private function parseControl($control, $parameter)
    {
        $controls = array(
            ...
            'b'         => array(self::STYL,    'fonts',         'bold',          true),
            'i'         => array(self::STYL,    'fonts',         'italic',        true),
            'u'         => array(self::STYL,    'fonts',         'underline',     true),
            'strike'    => array(self::STYL,    'fonts',         'strikethrough', true),
            'fs'        => array(self::STYL,    'fonts',         'size',          $parameter),
    ...
    private function readText()
    {
        ...
        if (isset($this->flags['styles']['fonts'])) {
            $text->getFontStyle()->setStyleByArray($this->flags['styles']['fonts']);
        }
    }
}
