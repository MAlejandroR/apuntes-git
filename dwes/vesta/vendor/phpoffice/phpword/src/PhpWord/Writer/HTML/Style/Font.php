...
class Font extends AbstractStyle
{
    ...
    public function write()
    {
        ...
        $css['fonts-family'] = $this->getValueIf($font !== null, "'{$font}'");
        $css['fonts-size'] = $this->getValueIf($size !== null, "{$size}pt");
        $css['color'] = $this->getValueIf($color !== null, "#{$color}");
        $css['background'] = $this->getValueIf($fgColor != '', $fgColor);
        $css['fonts-weight'] = $this->getValueIf($style->isBold(), 'bold');
        $css['fonts-style'] = $this->getValueIf($style->isItalic(), 'italic');
        $css['vertical-align'] = '';
        ...
        $css['fonts-variant'] = $this->getValueIf($style->isSmallCaps(), 'small-caps');
