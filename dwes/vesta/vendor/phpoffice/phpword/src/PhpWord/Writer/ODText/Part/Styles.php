...
class Styles extends AbstractPart
{
    ...
    private function writeDefault(XMLWriter $xmlWriter)
    {
        ...
        $xmlWriter->writeAttribute('style:use-window-fonts-color', 'true');
        $xmlWriter->writeAttribute('style:fonts-name', Settings::getDefaultFontName());
        $xmlWriter->writeAttribute('fo:fonts-size', Settings::getDefaultFontSize() . 'pt');
        ...
        $xmlWriter->writeAttribute('style:fonts-name-asian', Settings::getDefaultFontName() . '2');
        $xmlWriter->writeAttribute('style:fonts-size-asian', Settings::getDefaultFontSize() . 'pt');
        $xmlWriter->writeAttribute('style:language-asian', $asianLang[0]);
        $xmlWriter->writeAttribute('style:country-asian', $asianLang[1]);
        $xmlWriter->writeAttribute('style:fonts-name-complex', Settings::getDefaultFontName() . '2');
        $xmlWriter->writeAttribute('style:fonts-size-complex', Settings::getDefaultFontSize() . 'pt');
