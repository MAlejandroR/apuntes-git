...
/**
 * Word2007 fonts table writer: word/fontTable.xml
 *
...
class FontTable extends AbstractPart
{
    ...
    public function write()
    {
        ...
        $str .= '<w:fonts w:name="Times New Roman">';
        ...
        $str .= '<w:fonts w:name="Courier New">';
