...
class Html
{
    ...
    protected static function parseNode($node, $element, $styles = array(), $data = array())
    {
        ...
        $styleTypes = array('fonts', 'paragraph', 'list', 'table', 'row', 'cell');
        ...
        $nodes = array(
            ...
            'fonts'      => array('Span',        $node,  null,       $styles,    null,   null,           null),
    ...
    {
        $styles['fonts'] = self::recursiveParseStylesInHierarchy($node, $styles['fonts']);

        //alignment applies on paragraph, not on fonts. Let's copy it there
        if (isset($styles['fonts']['alignment']) && is_array($styles['paragraph'])) {
            $styles['paragraph']['alignment'] = $styles['fonts']['alignment'];
        }

        if (is_callable(array($element, 'addText'))) {
            $element->addText($node->nodeValue, $styles['fonts'], $styles['paragraph']);
        }
    }
    ...
    {
        $styles['fonts'][$argument1] = $argument2;
    }
    ...
    {
        self::parseInlineStyle($node, $styles['fonts']);
    }
    ...
    protected static function getListStyle($isOrderedList)
    {
        ...
        return array(
            ...
            'levels' => array(
                array('format' => NumberFormat::BULLET, 'text' => '', 'alignment' => 'left', 'tabPos' => 720,  'left' => 720,  'hanging' => 360, 'fonts' => 'Symbol',      'hint' => 'default'),
                array('format' => NumberFormat::BULLET, 'text' => 'o',  'alignment' => 'left', 'tabPos' => 1440, 'left' => 1440, 'hanging' => 360, 'fonts' => 'Courier New', 'hint' => 'default'),
                array('format' => NumberFormat::BULLET, 'text' => '', 'alignment' => 'left', 'tabPos' => 2160, 'left' => 2160, 'hanging' => 360, 'fonts' => 'Wingdings',   'hint' => 'default'),
                array('format' => NumberFormat::BULLET, 'text' => '', 'alignment' => 'left', 'tabPos' => 2880, 'left' => 2880, 'hanging' => 360, 'fonts' => 'Symbol',      'hint' => 'default'),
                array('format' => NumberFormat::BULLET, 'text' => 'o',  'alignment' => 'left', 'tabPos' => 3600, 'left' => 3600, 'hanging' => 360, 'fonts' => 'Courier New', 'hint' => 'default'),
                array('format' => NumberFormat::BULLET, 'text' => '', 'alignment' => 'left', 'tabPos' => 4320, 'left' => 4320, 'hanging' => 360, 'fonts' => 'Wingdings',   'hint' => 'default'),
                array('format' => NumberFormat::BULLET, 'text' => '', 'alignment' => 'left', 'tabPos' => 5040, 'left' => 5040, 'hanging' => 360, 'fonts' => 'Symbol',      'hint' => 'default'),
                array('format' => NumberFormat::BULLET, 'text' => 'o',  'alignment' => 'left', 'tabPos' => 5760, 'left' => 5760, 'hanging' => 360, 'fonts' => 'Courier New', 'hint' => 'default'),
                array('format' => NumberFormat::BULLET, 'text' => '', 'alignment' => 'left', 'tabPos' => 6480, 'left' => 6480, 'hanging' => 360, 'fonts' => 'Wingdings',   'hint' => 'default'),
            ),
        );
    }
    ...
    protected static function parseLink($node, $element, &$styles)
    {
        ...
        $styles['fonts'] = self::parseInlineStyle($node, $styles['fonts']);

        if (strpos($target, '#') === 0) {
            return $element->addLink(substr($target, 1), $node->textContent, $styles['fonts'], $styles['paragraph'], true);
        }

        return $element->addLink($target, $node->textContent, $styles['fonts'], $styles['paragraph']);
    }
}
