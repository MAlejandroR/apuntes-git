...
// Adding Text element to the Section having fonts styled by default...
$section->addText(
...
/*
 * Note: it's possible to customize fonts style of the Text element you add in three ways:
 * - inline;
 * - using named fonts style (new fonts style object will be implicitly created);
 * - using explicitly created fonts style object.
 */

// Adding Text element with fonts customized inline...
$section->addText(
...
// Adding Text element with fonts customized using named fonts style...
...
// Adding Text element with fonts customized using explicitly created fonts style object...
