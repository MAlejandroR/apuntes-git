...
class FileTest extends \PHPUnit\Framework\TestCase
{
    ...
    {
        $pathResources = PHPOFFICE_COMMON_TESTS_BASE_DIR.DIRECTORY_SEPARATOR.'resources_'.DIRECTORY_SEPARATOR;
    ...
    {
        $pathFiles = PHPOFFICE_COMMON_TESTS_BASE_DIR.DIRECTORY_SEPARATOR.'resources_'.DIRECTORY_SEPARATOR.'files'.DIRECTORY_SEPARATOR;
