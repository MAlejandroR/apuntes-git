...
class BundledComponentTest extends TestCase {
    ...
    protected function setUp() {
        $this->bundledComponent = new BundledComponent('phpunit/php_-code-coverage', new Version('4.0.2'));
    }
    ...
    public function testNameCanBeRetrieved() {
        $this->assertEquals('phpunit/php_-code-coverage', $this->bundledComponent->getName());
    }
